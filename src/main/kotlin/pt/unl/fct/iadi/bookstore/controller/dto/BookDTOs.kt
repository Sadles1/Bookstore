...
data class CreateBookRequest(
    ...
    @field:Schema(description = "Unique ISBN identifier", example = "9780132350884", requiredMode = Schema.RequiredMode.REQUIRED)
    val isbn: String?,

    @field:NotBlank(message = "Title must not be blank")
    @field:Size(min = 1, max = 120, message = "Title must be between 1 and 120 characters")
    @field:Schema(description = "Title of the book (1–120 characters)", example = "Clean Code", minLength = 1, maxLength = 120, requiredMode = Schema.RequiredMode.REQUIRED)
    val title: String?,
    ...
    @field:Schema(description = "Author of the book (1–80 characters)", example = "Robert C. Martin", minLength = 1, maxLength = 80, requiredMode = Schema.RequiredMode.REQUIRED)
    val author: String?,
    ...
    @field:Schema(description = "Price of the book, must be greater than 0", example = "34.99", minimum = "0", exclusiveMinimum = true, requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @field:Schema(description = "URL to the book cover image (must be a valid HTTP/HTTPS URL)", example = "https://example.com/images/clean-code.jpg", requiredMode = Schema.RequiredMode.REQUIRED)
    val image: String?
)
...
data class PatchBookRequest(
    @field:Size(min = 1, max = 120, message = "Title must be between 1 and 120 characters")
    @field:Schema(description = "Title of the book (1–120 characters)", example = "Clean Code", minLength = 1, maxLength = 120)
    val title: String?,

    @field:Size(min = 1, max = 80, message = "Author must be between 1 and 80 characters")
    @field:Schema(description = "Author of the book (1–80 characters)", example = "Robert C. Martin", minLength = 1, maxLength = 80)
    val author: String?,

    @field:DecimalMin(value = "0", inclusive = false, message = "Price must be greater than 0")
    @field:Schema(description = "Price of the book, must be greater than 0", example = "29.99", minimum = "0", exclusiveMinimum = true)
    val price: BigDecimal?,

    @field:Pattern(regexp = "^https?://.*", message = "Image must be a valid HTTP or HTTPS URL")
    @field:Schema(description = "URL to the book cover image (must be a valid HTTP/HTTPS URL)", example = "https://example.com/images/clean-code.jpg")
    val image: String?
)
